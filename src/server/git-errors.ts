...
export class GitTransactionError extends GitError {
  ...
  constructor(message: string, phase: 'prepare' | 'commit' | 'rollback', retryable: boolean = true) {
 ...
 */
export function formatErrorResponse(error: unknown): { status: number; body: any; headers?: Record<string, string> } {
