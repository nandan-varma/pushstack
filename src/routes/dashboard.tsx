		...
		<div className="page-wrap py-8">
			<div className="mb-8 flex items-center justify-between">
				<div>
					...
					<p className="mt-2 text-[var(--sea-ink-soft)]">{user.email}</p>
				</div>
											...
											<div>
												...
												<div className="mt-3 flex items-center gap-4 text-xs text-[var(--sea-ink-soft)]">
													<span className="flex items-center gap-1">
														<span
															className={`h-3 w-3 rounded-full ${repo.visibility === "public" ? "bg-green-500" : "bg-yellow-500"}`}
														/>
														{repo.visibility}
													</span>
													<span>
				...
				<div>
					...
					{activitiesLoading ? (
						<div className="space-y-3">
							{activitySkeletons.map((skeletonId) => (
								<div
									key={skeletonId}
